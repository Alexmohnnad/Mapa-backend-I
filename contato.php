	...
	<main>		
		<section>
			...
			<section class="main_prod">
				<article>
					<a href="#"><img src="/imagens/logo.jpg"alt="Image" height="100" width="170"></a>
					<h2>Entre em contato através de nosso telefone ou no canto da tela através do icone do whatsapp</h2>
					<p>+55 (69) x xxxx-xxxx</p>
                    <p>E-mail: xxxxxx@xxxxx.com.br</p>
